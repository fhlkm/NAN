...
public class FuseWifiAwareRTTActivity extends  AppCompatActivity implements SharedPreferences.OnSharedPreferenceChangeListener{
        private String TAG="FuseWifiAwareRTTActivity";
...
//  private final String              SERVICE_NAME                         = "org.wifi.nan.test";
        ...
        Set<PeerHandle> subscriberPeerHandleSet = new HashSet<>();
        ...
        private int                       pubType= PublishConfig.PUBLISH_TYPE_UNSOLICITED;
        private int                       subType=SubscribeConfig.SUBSCRIBE_TYPE_PASSIVE;
...
//  private final byte[]              pmk            = "123456789abcdef0123456789abcdef0".getBytes();
        ...
        final String subscribeSuccessWithDistance ="Subscribe successs with distance";

        final String publishSuccess ="Publish successs";
        final String publishSuccessWithDistance ="Publish successs with distance";
        @Override
        ...
        protected void onCreate(Bundle savedInstanceState) {
            ...
            fab.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    ...
                    if (publishDiscoverySession != null) {
                        for(PeerHandle ph : subscriberPeerHandleSet) {
            ...
            findViewById(R.id.btn_get_distance).setOnClickListener(v->{
                if(rttRangingManager ==null){
                    rttRangingManager = new RttRangingManager(this);
                }
                if(null != publisherPeerHandle){
                    rttRangingManager.startGetDistance(publisherPeerHandle);

                }else{
                    Log.d(TAG,"publisherPeerHandle is null");
                    displayToast("publisherPeerHandle is null");
                }
            });
            ...
            sendFileButton.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    try {
                        if (EncryptType.equals("open")) {
                            Toast.makeText(FuseWifiAwareRTTActivity.this, "Sending to port: " + portToUse, Toast.LENGTH_SHORT).show();
                            ...
                            Toast.makeText(FuseWifiAwareRTTActivity.this, "Sending to port: " + peerPort, Toast.LENGTH_SHORT).show();
        ...
        private void requestNetwork() {
            ...
            connectivityManager.requestNetwork(networkRequest, new NetworkCallback(){
                ...
                public void onLost(Network network) {
                    ...
                    Toast.makeText(FuseWifiAwareRTTActivity.this, "lost network", Toast.LENGTH_LONG).show();
                ...
                public void onUnavailable() {
                    super.onUnavailable();
                    Toast.makeText(FuseWifiAwareRTTActivity.this, "onUnavailable", Toast.LENGTH_SHORT).show();
                ...
                public void onCapabilitiesChanged(Network network, NetworkCapabilities networkCapabilities) {
                    ...
                    Toast.makeText(FuseWifiAwareRTTActivity.this, "onCapabilitiesChanged", Toast.LENGTH_SHORT).show();
                ...
                public void onLinkPropertiesChanged(Network network, LinkProperties linkProperties) {
                    ...
                    Toast.makeText(FuseWifiAwareRTTActivity.this, "onLinkPropertiesChanged", Toast.LENGTH_SHORT).show();
        ...
        private void publishService() {
            ...
            wifiAwareSession.publish(config, new DiscoverySessionCallback() {
                ...
                public void onPublishStarted(@NonNull PublishDiscoverySession session) {
                    ...
                    Log.d("publisher", "@onPublishStarted");
                    ...
                    if (publishDiscoverySession != null ) {
                        for(PeerHandle ph: subscriberPeerHandleSet) {
                            ...
                            Log.d("publisher", "@onPublishStarted sending mac");
                        }
                ...
                public void onServiceDiscovered(PeerHandle peerHandle_, byte[] serviceSpecificInfo, List<byte[]> matchFilter) {
                    ...
                    subscriberPeerHandleSet.add(peerHandle_);
                    subscriberPeerHandle = peerHandle_;
                    displayToast(publishSuccess);
                    Log.d("publisher ", "@onServiceDiscovered found peerHandle");
                }
                ...
                public void onServiceDiscoveredWithinRange(PeerHandle peerHandle_, byte[] serviceSpecificInfo, List<byte[]> matchFilter, int distanceMm) {
                    ...
                    subscriberPeerHandleSet.add(peerHandle_);
                    subscriberPeerHandle = peerHandle_;
                    displayToast(publishSuccessWithDistance);
                    Log.d("publisher", "@onServiceDiscoveredWithinRange onServiceDiscovered found peerHandle "+peerHandle_.toString()+" distance: "+distanceMm);
                    ((TextView)findViewById(R.id.distance)).setText(" peerHandle_ "+peerHandle_.hashCode()+"  distance: "+distanceMm);
                }
                ...
                public void onMessageReceived(PeerHandle peerHandle_, byte[] message) {
                    ...
                    subscriberPeerHandleSet.add(peerHandle_);
                    Log.d("publisher", "@onMessageReceived");
                    if(message.length == 2) {
                ...
                public void onSessionTerminated() {
                    ...
                    Log.d(TAG,"publisher onSessionTerminated");
                }
            }, null);
        ...
        private void subscribeToService() {
            ...
            wifiAwareSession.subscribe(config, new DiscoverySessionCallback() {
                ...
                public void onServiceDiscovered(PeerHandle peerHandle_, byte[] serviceSpecificInfo, List<byte[]> matchFilter) {
                    ...
                    Log.d("subscriber", "@onServiceDiscovered");
                    publisherPeerHandle = peerHandle_;
                    displayToast(subscribeSuccess);
                    if (subscribeDiscoverySession != null && publisherPeerHandle != null) {
                        ...
                        Log.d("subscriber", "onServiceDiscovered send mac");
                        Button responderButton = (Button)findViewById(R.id.responderButton);
                        Button initiatorButton = (Button)findViewById(R.id.initiatorButton);
                        initiatorButton.setEnabled(true);
                ...
                public void onSubscribeStarted(@NonNull SubscribeDiscoverySession session) {
                    ...
                    Log.d("subscriber", "@onSubscribeStarted");
                ...
                public void onServiceDiscoveredWithinRange(PeerHandle peerHandle_, byte[] serviceSpecificInfo, List<byte[]> matchFilter, int distanceMm) {
                    ...
                    Log.d("subscriber","@onServiceDiscoveredWithinRange peerHandle_ "+peerHandle_.hashCode()+"  distance: "+distanceMm);
                    ((TextView)findViewById(R.id.distance)).setText(" peerHandle_ "+peerHandle_.hashCode()+"  distance: "+distanceMm);

                    publisherPeerHandle = peerHandle_;
                    displayToast(subscribeSuccessWithDistance);
                ...
                public void onMessageReceived(PeerHandle peerHandle_, byte[] message) {
                    ...
                    publisherPeerHandle = peerHandle_;
                    Log.d("subscriber", "@onMessageReceived:  "+peerHandle_.hashCode()+"   message"+new String(message));
                    ...
                    if(message.length == 2) {
                        ...
                        setOtherMacAddress(message);
                        Toast.makeText(FuseWifiAwareRTTActivity.this, "mac received", Toast.LENGTH_SHORT).show();
                    } else if (message.length == 16) {
                        setOtherIPAddress(message);
                        Toast.makeText(FuseWifiAwareRTTActivity.this, "ip received", Toast.LENGTH_SHORT).show();
                    } else if (message.length > 16) {
                        setMessage(message);
                        //Toast.makeText(MainActivity.this, "message received", Toast.LENGTH_SHORT).show();
                    }
                ...
                public void onSessionTerminated() {
                    super.onSessionTerminated();
                    Log.d(TAG,"receiver @onSessionTerminated");
                }
            }, null);
        }
        //-------------------------------------------------------------------------------------------- -----
